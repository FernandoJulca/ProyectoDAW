...
CREATE TABLE TB_PEDIDO (
    ...
    QR_VERIFICATION_CODE VARCHAR(150) UNIQUE NOT NULL,
    ID_REPARTIDOR INT,
    ...
    TIEMPO_ENTREGA_MINUTOS INT,            -- métrica de negocio (dif d minutos entre EN y EC)
    ESTADO_DELIVERY VARCHAR(2) DEFAULT 'PE',
    OBSERVACIONES TEXT,
    FOREIGN KEY (ID_VENTA) REFERENCES TB_VENTA(ID_VENTA),
    FOREIGN KEY (ID_REPARTIDOR) REFERENCES TB_USUARIO(ID_USUARIO),
    CONSTRAINT CHK_ESTADO_DELIVERY CHECK (ESTADO_DELIVERY IN ('PE','AS','EC','EN','FA'))
);

CREATE TABLE TB_CALIFICACION (
    ID_CALIFICACION SERIAL PRIMARY KEY,
    ID_DELIVERY INT NOT NULL UNIQUE,
    ID_USUARIO INT NOT NULL,
    ID_REPARTIDOR INT NOT NULL,
    PUNTUACION SMALLINT NOT NULL, -- Calificación de 1 a 5 estrellas
    COMENTARIO TEXT,
